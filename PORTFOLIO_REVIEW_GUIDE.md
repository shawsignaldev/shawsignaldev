...
This guide is designed for recruiters, hiring managers, and technical interviewers who want to evaluate the portfolio quickly.
...
The portfolio is organized around systems that make complex domains easier to observe and control:

- ARGUS turns market uncertainty into risk diagnostics and control-style research artifacts.
- CIPHER organizes market prep and review into a repeatable terminal workflow.
...
- Each major repository has a README, architecture docs, examples, tests, security notes, and a changelog.
- Finance-related repositories include explicit educational/research disclaimers.
- Credentials, account data, private logs, and restricted coursework are excluded.
- Public examples use deterministic sample data or sanitized documentation.
- Repository language separates implemented safe components from future roadmap items.
